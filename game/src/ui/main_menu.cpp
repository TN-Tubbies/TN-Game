...
{
    SDL_Surface *button_surf = TTF_RenderUTF8_Blended(Get_Roboto(64), text.c_str(), {255, 255, 255, 255});
...
MainMenu::MainMenu()
{
    SDL_Surface *title_surf = TTF_RenderUTF8_Solid(Get_Jersey(128), "TN-Game", {255, 255, 255, 255});
...
void MainMenu::HandleMouseHover()
{
    int mouse_x, mouse_y;
...
void MainMenu::HandleMouseClick(DisplayState *displayState)
{
    int mouse_x, mouse_y;
    SDL_GetMouseState(&mouse_x, &mouse_y);
    for (MenuButton &button : *this->buttons)
